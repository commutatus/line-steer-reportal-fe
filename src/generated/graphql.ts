...
/** Autogenerated input type of ExportFactoryDetails */
export type ExportFactoryDetailsInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  dateRange: DateRange;
};
...
export type Factory = {
  ...
  createdAt: Scalars['ISO8601DateTime']['output'];
  escalationCutoffTime?: Maybe<Scalars['ISO8601DateTime']['output']>;
  id: Scalars['ID']['output'];
...
export type Mutation = {
  ...
  /** Export factory details as Excel and email to current user */
  exportFactoryDetails?: Maybe<Scalars['Boolean']['output']>;
...
export type MutationExportFactoryDetailsArgs = {
  input: ExportFactoryDetailsInput;
};
...
export type ExportFactoryDetailsMutationVariables = Exact<{
  input: ExportFactoryDetailsInput;
}>;


export type ExportFactoryDetailsMutation = { __typename?: 'Mutation', exportFactoryDetails?: boolean | null };
